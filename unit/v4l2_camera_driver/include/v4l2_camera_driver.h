...
public:
  v4l2_camera_driver(const unit::v4l2_camera_driver::Args& args, const std::optional<std::string_view>& name_override = {}) : args(args), unit::v4l2_camera_driver::Base(name_override) {}
